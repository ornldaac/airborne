...
A majority of the BioSCape Campaign data are archived at  https://www.earthdata.nasa.gov/data/projects/bioscape.

## Data Tutorials

- [Cloud-based Access and Analysis of AVIRIS Data](../../notebooks/aviris/2_AVIRIS_AccessandAnalysis.ipynb)
